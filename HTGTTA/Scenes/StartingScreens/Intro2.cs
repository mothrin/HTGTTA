...
{
    public class Intro2 : SceneFadeBase
    {
        ...
        public Intro2(Game game, string name, string nextScene) : base(game, name) { NextScene = nextScene; }
        ...
        {
            _bgTexture = Game.Content.Load<Texture2D>("Textures/backgrounds/Intro/startscreen2");
