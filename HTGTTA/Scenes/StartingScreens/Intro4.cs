...
{
    public class Intro4 : SceneFadeBase
    {
        ...
        public Intro4(Game game, string name, string nextScene) : base(game, name) { NextScene = nextScene; }
        ...
        {
            _bgTexture = Game.Content.Load<Texture2D>("Textures/backgrounds/Intro/startscreen4");
