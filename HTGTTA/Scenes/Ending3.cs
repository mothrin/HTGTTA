...
{
    public class Ending3 : SceneFadeBase
    {
        ...
        public Ending3(Game game, string name, string nextScene) : base(game, name) { NextScene = nextScene; }
        ...
        protected override void LoadContent()
        {
            ...
            _bgTexture = Game.Content.Load<Texture2D>("Textures/backgrounds/Ending3");
