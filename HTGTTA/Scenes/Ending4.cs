...
{
    public class Ending4 : SceneFadeBase
    {
        ...
        public Ending4(Game game, string name, string nextScene) : base(game, name) { NextScene = nextScene; }
        ...
        protected override void LoadContent()
        {
            ...
            _bgTexture = Game.Content.Load<Texture2D>("Textures/backgrounds/Ending4");
